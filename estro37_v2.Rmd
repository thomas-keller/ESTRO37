...
hm=tidy_cloud %>%
 count(word)
library(wordcloud)
wordcloud(hm$word, hm$n,colors=brewer.pal(8,'Dark2'),random.order=FALSE,random.color=FALSE,min.freq=3)
 
```


<p align="center"><img width="100%" height="auto" src="wordcloud.png" /></p>
...
<p align="center"><img width="100%" height="auto" src="estro37_retweet_net.png" /></p>
